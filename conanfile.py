...
class VolumeLoaderPluginConan(ConanFile):
    ...
    description = (
        "A Plugin for loading volume data in ManiVaultStudio."
    )
    topics = ("hdps", "plugin", "volume data", "viewing")
    url = "https://github.com/ManiVaultStudio/VolumeLoaderPlugin"
    ...
    def _configure_cmake(self):
        cmake = CMake(self)
        cmake.configure(build_script_folder="hdps/VolumeLoaderPlugin")
        cmake.verbose = True
        return cmake
